      ...
      colors: {
        faster: {
          ...
          nav: {
            ...
            active: 'var(--color-nav-active-bg)',
            activeText: 'var(--color-nav-active-text)',
          },
          card: 'var(--color-card-bg)',
          subscribe: 'var(--color-subscribe-bg)',
