...
import { CANONICAL_SITE_ORIGIN } from '@/utilities/siteMetadata'
import { getCachedGlobal } from '@/utilities/getGlobals'
import type { Footer as FooterType, Header as HeaderType } from '@/payload-types'

import './globals.css'
import { fontOpenSans, frontendFontVariables } from './fonts'
    ...
    >
      ...
      <body className={fontOpenSans.className}>
        <Providers>
          ...
          <Header data={headerFailed ? null : headerData} />
          {children}
...
export const metadata: Metadata = {
  ...
  description:
    'FASTER creates, connects, and cultivates a movement of Filipinx Americans in STEAM.',
  metadataBase: new URL(getServerSideURL()),
  openGraph: mergeOpenGraph(),
  title: 'FASTER - Filipinx Americans in STEAM',
  twitter: {
